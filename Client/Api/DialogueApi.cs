...
namespace chat_winForm.Client.Api
{
    ...
    class DialogueApi
    {
        ...
        /// 友達トークリストの取得をするAPI
        /// </summary>
        /// <param name="outhToken">認証用トークン認証用トークン</param>
        ...
        static public List<TalkResponse> GetDiarogueTalks(String outhToken, String userIdName, int maxSize, int startIndex)
        {
